...
import ContentSection from '../components/contactus'
import CtaSection from '../components/Cta'
import TestimonialSection from '../components/Testinomials'
import FooterBlock from '../components/Footer'
import Timeline from '../components/Howitwork.jsx'
        ...
        <nav className="relative mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex gap-x-5 justify-between items-center">
            <div className="flex items-center min-w-max">
                <a href="/" className="font-semibold flex items-center gap-x-2">
                    ...
                    <span className="text-lg text-gray-700 dark:text-gray-300">MechAssist</span>
                </a>
            </div>
            <div className={`
            ...
            `}>
                <ul className="flex flex-col lg:flex-row gap-6 lg:items-center text-gray-700 dark:text-gray-300 lg:w-full lg:justify-center">
                    <li>
                        <a href="#" className="px-2 transition-colors  py-2.5 hover:text-purple-600 "></a>
                    </li>
                    <li>
                        <a href="#" className="px-2 transition-colors  py-2.5 hover:text-purple-600 "></a>
                    </li>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4  lg:min-w-max mt-10 lg:mt-0">
                    <a href="/login" className="flex items-center justify-center w-full sm:w-auto h-12 px-6 rounded-full bg-gray-100 dark:bg-gray-900 text-purple-600 dark:text-gray-300 border border-gray-200 dark:border-gray-800">
                        Login
                    </a>
                </div>
            </div>
        ...
        <section className="min-h-max bg-white dark:bg-gray-950">
            ...
            <div className="relative mx-auto pt-32 pb-24 lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 text-center space-y-10">
                <h1 className="text-gray-900 dark:text-white mx-auto max-w-5xl font-bold text-4xl/tight sm:text-5xl/tight lg:text-6xl/tight xl:text-7xl/tight">
                  Your Roadside Savior for Every Mile!
                </h1>
                <p className="text-gray-700 dark:text-gray-300 mx-auto max-w-2xl">
                Stuck on the road? Find trusted mechanics, towing services, or fuel supply near you in just a few clicks. Get back on your journey with ease!
                </p>
                <div className="flex justify-center items-center flex-wrap mx-auto gap-4">
                    <a href="/login" className="flex items-center h-12 px-6 rounded-full bg-purple-600 text-white border border-purple-600">
                        Get Start!
                    </a>
